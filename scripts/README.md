...
| [`check-crawler-policy.js`](check-crawler-policy.js) | Assert the live site allows answer engines and refuses training crawlers (`npm run check:crawlers`). Hits production, so it is not in CI. |
